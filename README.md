...
> **[*Finetuning a World Action Model (WAM)*](https://wandb.ai/encord-wb-physical-ai/wam-finetune-webinar/reports/Finetuning-a-World-Action-Model-WAM---VmlldzoxNzU2NzA3MQ).

<p align="center">
  <img src="./assets/trossen-WAM.gif" alt="New Embodiment Rollout" width="300" />
</p>
<p align="center"><em>Top 3 frames show the video dreams generated by the model and bottom 3 videos are the real actions in IsaacLab</em></p>
